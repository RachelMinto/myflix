...
#         # expect(assigns(:queued_videos)).to eq([user_video])
#       end
...
#         before { post :create, :user_video => { order: 1 } }

#         it "should give an error"
#         it "should redirect to video#show"
#         it "should not create a user_video" do
#           expect(UserVideo.first).to eq(nil)
#         end
#       end
...
#           expect(UserVideo.first).to eq(user_video)
#         end
