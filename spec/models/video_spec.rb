...
describe Video do
  ...
  describe "search_by_title" do
    it "returns empty array if there is no match" do
      Video.create(title: 'futurama', description: 'something', small_cover: "asdf", large_cover: "asdf")
    ...
    it "returns an array of one video for a partial match" do
      futurama = Video.create(title: 'futurama II', description: 'something', small_cover: "asdf", large_cover: "asdf")
      expect(Video.search_by_title('futurama')).to eq([futurama])    
    end

    it "returns an array of matches ordered by created_at DESC" do
      futurama = Video.create(title: 'futurama', description: 'something', small_cover: "asdf", large_cover: "asdf")
      futurama2 = Video.create(title: 'futurama II', description: 'something', small_cover: "asdf", large_cover: "asdf", created_at: 1.day.ago)
    ...
    it "should search_by_title and return multiple matches as an array" do
      futurama = Video.create(title: 'futurama', description: 'something', small_cover: "asdf", large_cover: "asdf")
      futurama2 = Video.create(title: 'futurama II', description: 'something', small_cover: "asdf", large_cover: "asdf")
